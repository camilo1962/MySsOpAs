...
public class WordsGrid : MonoBehaviour
{
    ...
    private Vector2 GetFirstSquarePosition()
    {
        ...
        startPosition.y = midWidthHeight -6;
        ...
        if (currentGameData != null)
        {
            ...
            foreach (var squares in currentGameData.selectedBoardData.Board)
            {
                foreach (var squareLetter in squares.Row)
                {
                    ...
                    {
                        Debug.LogError(
                       "Todos los campos de su matriz deben tener algunas letras. Presione Rellenar con el botón aleatorio en los datos de su tablero para agregar una letra aleatoria. Letra: + letra cuadrada");
